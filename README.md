...
8. Вычисление максимального количества исправляемых ошибок матрицы G:

   По формуле из пункта 12 описания методов это число равно целой части от (3 - 1) / 2 = 1.

 <p align="center">
<img width="300" alt="image" src="https://github.com/user-attachments/assets/9313f2de-b83e-4b7e-b721-ef61c1a5c7ec" />
</p>
